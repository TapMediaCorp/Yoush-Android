package com.tapmedia.yoush.color;
...
import static com.tapmedia.yoush.util.ThemeUtil.isDarkTheme;

public enum MaterialColor {
  CRIMSON    (R.color.main_color_500,     R.color.main_color_300,     R.color.main_color_600,     "red"),
