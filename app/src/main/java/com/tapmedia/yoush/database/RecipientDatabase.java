...
import com.tapmedia.yoush.jobs.WakeGroupV2Job;
...
import com.tapmedia.yoush.storage.StorageSyncHelper.RecordUpdate;
...
public class RecipientDatabase extends Database {
   ...
   */
  public boolean update(@NonNull RecipientId id, @NonNull ContentValues contentValues) {
    String              selection   = ID + " = ?";
    String[]            args        = new String[]{id.serialize()};
  ...
  public class BulkOperationsHandle {
                                     ...
                                     @Nullable String systemContactUri)
    {
      ...
      String oldName = recipient.getName(context);
