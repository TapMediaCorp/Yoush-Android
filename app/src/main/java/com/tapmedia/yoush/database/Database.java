...
public abstract class Database {
  ...
  public       SQLCipherOpenHelper databaseHelper;
  ...
  public void setNotifyConversationListeners(Cursor cursor, long threadId) {
  ...
  public void setNotifyConversationListListeners(Cursor cursor) {
