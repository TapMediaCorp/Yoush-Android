...
import com.tapmedia.yoush.crypto.ClassicDecryptingPartInputStream;
import com.tapmedia.yoush.crypto.ModernDecryptingPartInputStream;
import com.tapmedia.yoush.crypto.ModernEncryptingPartOutputStream;
import com.tapmedia.yoush.database.helpers.SQLCipherOpenHelper;
import com.tapmedia.yoush.database.model.databaseprotos.AudioWaveFormData;
...
import com.tapmedia.yoush.util.MediaUtil.ThumbnailData;
import com.tapmedia.yoush.util.StorageUtil;
import com.tapmedia.yoush.util.Util;
import com.tapmedia.yoush.video.EncryptedMediaDataSource;
...
public class AttachmentDatabase extends Database {
  ...
  public @NonNull Map<Attachment, AttachmentId> insertAttachmentsForMessage(long mmsId, @NonNull List<Attachment> attachments, @NonNull List<Attachment> quoteAttachment)
      throws MmsException
  {
