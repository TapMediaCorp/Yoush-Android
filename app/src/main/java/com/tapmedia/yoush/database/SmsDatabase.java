...
public class SmsDatabase extends MessagingDatabase {
  ...
  public static final EarlyReceiptCache earlyDeliveryReceiptCache = new EarlyReceiptCache("SmsDelivery");
  ...
  protected Optional<InsertResult> insertMessageInbox(IncomingTextMessage message, long type) {
    ...
    boolean    unread     = (com.tapmedia.yoush.util.Util.isDefaultSmsProvider(context) ||
  ...
  public boolean isDuplicate(IncomingTextMessage message, long threadId) {
