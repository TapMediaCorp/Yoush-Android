...
public final class WelcomeFragment extends BaseRegistrationFragment {
  ...
  private void continueClicked(@NonNull View view) {
    Permissions.with(this)
               ...
               .ifNecessary()
               .withRationaleDialog(getString(R.string.RegistrationActivity_yoush_needs_access_to_your_contacts_and_media_in_order_to_connect_with_friends),
                 R.drawable.ic_contacts_white_48dp_new, R.drawable.ic_folder_white_48dp_new)
               .onAnyResult(() -> {
