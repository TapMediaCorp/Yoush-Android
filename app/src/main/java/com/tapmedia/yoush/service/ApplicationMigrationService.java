...
import com.tapmedia.yoush.database.SmsMigrator;
import com.tapmedia.yoush.database.SmsMigrator.ProgressDescription;
import com.tapmedia.yoush.notifications.NotificationChannels;
import com.tapmedia.yoush.notifications.NotificationIds;
    ...
    implements SmsMigrator.SmsMigrationProgressListener
{
  ...
  public  static final String MIGRATE_DATABASE  = "com.tapmedia.yoush.ApplicationMigration.MIGRATE_DATABSE";
  public  static final String COMPLETED_ACTION  = "com.tapmedia.yoush.ApplicationMigrationService.COMPLETED";
  ...
  private NotificationCompat.Builder initializeBackgroundNotification() {
    ...
    builder.setSmallIcon(R.drawable.ic_noti_new);
    builder.setLargeIcon(BitmapFactory.decodeResource(getResources(), R.drawable.ic_noti_new));
