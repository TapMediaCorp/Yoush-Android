...
public class MmsBodyProvider extends ContentProvider {
  ...
  private static final String CONTENT_URI_STRING = "content://com.tapmedia.provider.yoush.mms/mms";
  ...
  static {
    ...
    uriMatcher.addURI("com.tapmedia.provider.yoush.mms", "mms/#", SINGLE_ROW);
  }
