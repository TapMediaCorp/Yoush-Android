...
import com.tapmedia.yoush.util.IOFunction;
import com.tapmedia.yoush.util.Util;
import com.tapmedia.yoush.util.concurrent.SignalExecutors;
import com.tapmedia.yoush.video.ByteArrayMediaDataSource;
...
public class BlobProvider {
  ...
  public static final Uri        CONTENT_URI = Uri.parse("content://com.tapmedia.yoush/blob");
  public static final String     AUTHORITY   = "com.tapmedia.yoush";
