...
import com.tapmedia.yoush.mms.OutgoingLegacyMmsConnection;
...
//    return 90 - age;
  ...
  public static String getJitsiToken(String name) throws UnsupportedEncodingException {
    Map<String, String> userClaims = new HashMap<String, String>();
    // userClaims.put("avatar", "https:/gravatar.com/avatar/abc123");
    userClaims.put("name", name);
    userClaims.put("email", "tapmedia.corporation@gmail.com");

    Map<String, Object> contextClaims = new HashMap<String, Object>();
    contextClaims.put("user", userClaims);
    ...
    Long exp = 15000016923L;

    Object moderatorObj = moderator;
    Object audObj = aud;
    Object issObj = iss;
    Object subObj = sub;
    Object roomObj = room;
    ...
    claims.put("context",contextClaims);
    claims.put("moderator",moderatorObj);
    claims.put("aud",audObj);
    claims.put("iss",issObj);
    claims.put("sub",subObj);
    claims.put("room",roomObj);
    claims.put("exp",expObj);

    byte[] app_secret = "".getBytes("UTF-8");
  ...
  public static String encryptAES(String jsonData) {
    ...
    try {
      Recipient recipient = Recipient.self();
      String SECRET_KEY = "" + recipient.getE164().get();
      SecretKeySpec skeySpec = new SecretKeySpec(SECRET_KEY.getBytes(), "AES");

      String original = jsonData;
      Cipher cipher = Cipher.getInstance("AES/ECB/PKCS5PADDING");
      cipher.init(Cipher.ENCRYPT_MODE, skeySpec);
      byte[] byteEncrypted = cipher.doFinal(original.getBytes());
      String encryptedData =  android.util.Base64.encodeToString(byteEncrypted, android.util.Base64.DEFAULT);
