...
import com.tapmedia.yoush.util.dynamiclanguage.LanguageString;

import java.util.Locale;

/**
 * @deprecated Use a base activity that uses the {@link com.tapmedia.yoush.util.dynamiclanguage.DynamicLanguageContextWrapper}
 */
@Deprecated
