...
import com.tapmedia.yoush.components.emoji.EmojiPageView;
import com.tapmedia.yoush.components.emoji.EmojiPageViewGridAdapter;
...
import static com.tapmedia.yoush.R.layout.react_with_any_emoji_tab;
...
public final class ReactWithAnyEmojiBottomSheetDialogFragment extends BottomSheetDialogFragment implements EmojiKeyboardProvider.EmojiEventListener, EmojiPageViewGridAdapter.VariationSelectorListener {
  ...
  public void onActivityCreated(@Nullable Bundle savedInstanceState) {
    ...
    if (savedInstanceState == null) {
      FrameLayout    container       = requireDialog().findViewById(R.id.viewFragmentContainer);
