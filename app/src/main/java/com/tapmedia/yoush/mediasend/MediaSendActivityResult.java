...
public class MediaSendActivityResult implements Parcelable {
  ...
  public static @NonNull MediaSendActivityResult forPreUpload(@NonNull Collection<PreUploadResult> uploadResults,
                                                       @NonNull String body,
 ...
 public static @NonNull MediaSendActivityResult forTraditionalSend(@NonNull List<Media> nonUploadedMedia,
                                                             @NonNull String body,
                                                             @NonNull TransportOption transport,
                                                             boolean viewOnce)
  {
