...
import com.tapmedia.yoush.contacts.avatars.GroupRecordContactPhoto;
...
import com.tapmedia.yoush.contacts.avatars.SystemContactPhoto;
import com.tapmedia.yoush.contacts.avatars.TransparentContactPhoto;
...
import static com.tapmedia.yoush.database.RecipientDatabase.InsightsBannerTier;
...
//    } else
  ...
  public static class FallbackPhotoProvider implements Serializable{
    public @NonNull FallbackContactPhoto getPhotoForLocalNumber() {
      return new ResourceContactPhoto(R.drawable.ic_note_24_new, R.drawable.ic_note_24_new);
    }
    ...
    public @NonNull FallbackContactPhoto getPhotoForGroup() {
      return new ResourceContactPhoto(R.drawable.ic_group_outline_34_new, R.drawable.ic_group_outline_20_new, R.drawable.ic_group_outline_48_new);
    }

    public @NonNull FallbackContactPhoto getPhotoForRecipientWithName(String name) {
      return new GeneratedContactPhoto(name, R.drawable.ic_profile_outline_40_new);
    }

    public @NonNull FallbackContactPhoto getPhotoForRecipientWithoutName() {
      return new ResourceContactPhoto(R.drawable.ic_profile_outline_40_new, R.drawable.ic_profile_outline_20_new, R.drawable.ic_profile_outline_48_new);
    }
