...
import com.tapmedia.yoush.components.ArcProgressBar;
...
public final class InsightsDashboardDialogFragment extends DialogFragment {
  ...
  private void setupStartAConversation() {
    startAConversation.setOnClickListener(v -> startActivity(new Intent(requireActivity(), ContactSelectionActivity.class)));
  }
