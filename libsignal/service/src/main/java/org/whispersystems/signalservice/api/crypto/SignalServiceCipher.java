...
public class SignalServiceCipher {
      ...
      throws UntrustedIdentityException, InvalidKeyException
  {
    if (unidentifiedAccess.isPresent()) {
      ...
      return new OutgoingPushMessage(Type.UNIDENTIFIED_SENDER_VALUE, destination.getDeviceId(), remoteRegistrationId, body, null, null, null, 0, "", "", null);
    } else {
      ...
      return new OutgoingPushMessage(type, destination.getDeviceId(), remoteRegistrationId, body, null, null, null, 0, "","", null);
    }
  }
